...
//             document.querySelector("#page3 video").playbackRate = 1;
//         }
//     }
// })
...
gsap.to("#page3 video", {
    scrollTrigger: {
        ...
        scroller: `#main`,
        // markers: true,
        scrub: true, // Enable scrubbing to tie video progress to scroll
        // onEnter: () => {
...
function canvas1(){
    ...
    scrollTrigger: {
        ...
        start: `-50% top`,  /////////////change start end according to preference
        end: `400% top`,    /////////////400% is the total height of the canvas and where the canvas ends
        scroller: `#main`,
        // markers:true
    },
    onUpdate: render,
...
function canvas2(){
    ...
    function files(index) {
        var data = `
        canvas images 2/Vision00001.png
        canvas images 2/Vision00002.png
        canvas images 2/Vision00003.png
        canvas images 2/Vision00004.png
        canvas images 2/Vision00005.png
        canvas images 2/Vision00006.png
        canvas images 2/Vision00007.png
        canvas images 2/Vision00008.png
        canvas images 2/Vision00009.png
        canvas images 2/Vision00010.png
        canvas images 2/Vision00011.png
        canvas images 2/Vision00012.png
        canvas images 2/Vision00013.png
        canvas images 2/Vision00014.png
        canvas images 2/Vision00015.png
        canvas images 2/Vision00016.png
        canvas images 2/Vision00017.png
        canvas images 2/Vision00018.png
        canvas images 2/Vision00019.png
        canvas images 2/Vision00020.png
        canvas images 2/Vision00021.png
        canvas images 2/Vision00022.png
        canvas images 2/Vision00023.png
        canvas images 2/Vision00024.png
        canvas images 2/Vision00025.png
        `;
    return data.split("\n")[index];
    }
    ...
    scrollTrigger: {
        ...
        end: `90% top`,    /////////////400% is the total height of the canvas and where the canvas ends
        scroller: `#main`,
        // markers:true
    },
    onUpdate: render,
